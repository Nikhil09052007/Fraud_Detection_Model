...
│
├── README.md                          # Project overview + full learning path map
├── CONTRIBUTING.md                    # (optional) How to extend the knowledge base
├── LICENSE
├── requirements.txt
├── .gitignore
│
├── docs/                              # ← All theoretical knowledge lives here (clean root)
│   ├── README.md                      # Master index of the explanation tree
│   │
│   ├── 01_FINANCIAL_WORLD/
│   │   ├── README.md
│   │   ├── What_is_Money.md
